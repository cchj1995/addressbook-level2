...
Modifies an existing person in the address book. +
Format: `modify INDEX NAME [p]p/PHONE_NUMBER [p]e/EMAIL [p]a/ADDRESS [t/TAG]...`


****

Modifies the person at the specified `INDEX`.
The index refers to the index number shown in the most recent listing.

Must key in all the required parameters as with the 'add' command to modify entry
...
Examples:
* `list`
* `modify 2 John Doe p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01`

* `find John`
* `modify 1 Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/Newgate Prison t/criminal t/friend`
